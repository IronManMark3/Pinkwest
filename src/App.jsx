...
import { submitFormToGoogleSheet } from "./utils/backend";
...
export default function PinkWestAestheticLanding() {
 ...
 // 'exterior' or 'interior'
  ...
  const handleSubmit = async (e, type = "form") => {
    e.preventDefault();
    ...
    if (!Object.values(newErrors).some((error) => error)) {
      const response = await submitFormToGoogleSheet(formData, type);
      ...
      // Redirect to Thank You page (for non-brochure)
      if (type !== "brochure") {
        navigate("/thank-you");
      }
      ...
      setShowTooltips({ name: false, phone: false, email: false, lookingFor: false });
    }    
  };
  ...
  <About />
        ...
        >
          ...
          {(() => {
            ...
            return (
              <>
                ...
                {/* SVG Background Right (not mirrored) */}
                <div
                  ref={rightSvgRef}
                  style={{
                    position: "absolute",
          ...
          <p
            ...
            style={{ position: "relative", zIndex: 2 }}
          >
            West Jaipur’s largest commercial hub with 6% assured returns, high footfall potential, and excellent
             connectivity — Pinkwest is designed for strong rental yield and long-term growth.
          </p>
        </section>
        <section data-aos="fade-up">
          <Location />
